...
exports.interview = function(request, response) {
	...
	// Find an in-progress survey if one exists, otherwise create one
	SurveyResponse.advanceSurvey({
		...
		if (err || !surveyResponse) {
			say('Terribly sorry, but an error has occurred. Goodby.');
			return respond();
		}
...
// Transcription callback - called by Twilio with transcript of recording
